                            ...
                            <div id="accordion">
                                <div class="card card-secondary">
                                    ...
                                    <div id="collapseOne" class="collapse show" data-parent="#accordion">
                                        <div class="card-body">
                                            <form id="EditDepartment" class="form-horizontal row" action="{{ route('Dashboard | Update Department', $department->id) }}" method="POST">
                                            @csrf
                                            @method('PUT')
                                                <div class="form-group col-md-12">
                                                    <label for="department">Department Name</label>
                                                    <input type="text" id="department" name="department" value="{{ $department->department_name }}" class="form-control" required>
                                                </div>
                                                <div class="col-12">
                                                    <button type="submit" class="btn btn-success float-right">Update Department</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                    ...
                                    @if (!empty($departments) && $departments->count())
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-center">
                                                <a class="btn btn-outline-secondary btn-sm" href="{{ 'view-profile/'.$department->id }}" data-toggle="lightbox" data-title="User Profile">
                                                    <i class="fa fa-edit">
                                                    </i>
                                                    {{__('Edit')}}
                                                </a>
                                ...
                                <div class="card-body table-responsive p-0">
                                    ...
                                    @if (!empty($specialities) && $specialities->count())
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-center">
                                                <a class="btn btn-outline-secondary btn-sm" href="{{ 'view-profile/'.$speciality->id }}" data-toggle="lightbox" data-title="User Profile">
                                                    <i class="fa fa-edit">
                                                    </i>
                                                    {{__('Edit')}}
                                                </a>
                                                <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Confirm to DELETE {{ $speciality->speciality_name }} Speciality?')" href="{{ 'delete-user/'.$speciality->id }}">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                    {{__('Delete')}}
                                                </a>
                                    ...
                                    @if (!empty($offices) && $offices->count())
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-actions text-center">
                                                ...
                                                <a class="btn btn-outline-danger btn-sm" onclick="return confirm('Confirm to DELETE {{ $office->office_name }} Office?')" href="{{ 'delete-user/'.$speciality->id }}">
                                                    <i class="fa fa-trash">
                                                    </i>
                                                    {{__('Delete')}}
                                                </a>
